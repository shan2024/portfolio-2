  ...
  return (
    <div className="studio">
      <div className = "projects studio-section">
        ...
        <ProjectLink title = "Social media app" link="/projects/social" date = "August 2022"></ProjectLink>
        ...
        <ProjectLink title = "Solar sizing" link="/projects/solar" date = "November 2021"></ProjectLink>
      </div>
      <div className = "other studio-section">
        ...
        <ProjectLink title = "Battleship" link="/projects/battleship" date = "November 2021"></ProjectLink>
        <ProjectLink title = "Weather app" link="/projects/weather" date = "September 2021"></ProjectLink>
